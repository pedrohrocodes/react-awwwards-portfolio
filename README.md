...
This is a fully animated, interactive, 3D developer portfolio. It's more than a portfolio—it's a web experience built with production-level code, scroll-based animations, and real-world best practices.
...
```bash
git clone https://github.com/pedrohrocodes/react-awwwards-portfolio.git
...
- 📬 [Connect on LinkedIn](https://www.linkedin.com/in/pedrohrocodes)